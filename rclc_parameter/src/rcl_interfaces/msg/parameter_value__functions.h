...
#ifndef RCL_PARAMETERS__MSG__DETAIL__PARAMETER_VALUE__FUNCTIONS_H_
#define RCL_PARAMETERS__MSG__DETAIL__PARAMETER_VALUE__FUNCTIONS_H_
 ...
 * )) before or use
 * parameter__ParameterValue__create()
 ...
 * calls
 * parameter__ParameterValue__init().
...
/**
 * It calls
 * parameter__ParameterValue__fini()
 ...
 * parameter__ParameterValue__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * parameter__ParameterValue__Sequence__fini()
 * on the array,
...
#endif  // RCL_PARAMETERS__MSG__DETAIL__PARAMETER_VALUE__FUNCTIONS_H_
