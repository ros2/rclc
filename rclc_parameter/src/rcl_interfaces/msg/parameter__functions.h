...
#ifndef RCL_PARAMETERS__MSG__DETAIL__PARAMETER__FUNCTIONS_H_
#define RCL_PARAMETERS__MSG__DETAIL__PARAMETER__FUNCTIONS_H_
 ...
 * parameter__Parameter__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * parameter__Parameter__Sequence__fini()
 * on the array,
...
#endif  // RCL_PARAMETERS__MSG__DETAIL__PARAMETER__FUNCTIONS_H_
